...
: The hit summary is stored in a HashMap. For each input one hash insertion/loopup
:   is required,  so it's O(1) insertion and lookup.
Since the cardinality of hit count values and the number of days are much smaller
